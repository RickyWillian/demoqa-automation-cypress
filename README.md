...
Este projeto contém uma suíte de testes automatizados para o site [DemoQA](https://demoqa.com/), focando em componentes complexos como **Web Tables** e **Progress Bar**. O objetivo é demonstrar habilidades em automação E2E, lógica de sincronismo e boas práticas de arquitetura.
...
- **Progress Bar:** Automação baseada em estados assíncronos, com interrupção precisa e reset de componente.
